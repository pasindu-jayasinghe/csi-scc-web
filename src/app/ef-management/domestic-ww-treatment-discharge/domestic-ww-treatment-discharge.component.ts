...
import { DomesticWWTreatmentDischarge, ServiceProxy, WasteIncineration } from 'shared/service-proxies/es-service-proxies';

@Component({
  selector: 'app-domestic-ww-treatment-discharge',
  templateUrl: './domestic-ww-treatment-discharge.component.html',
  styleUrls: ['./domestic-ww-treatment-discharge.component.css']
})
export class DomesticWwTreatmentDischargeComponent implements OnInit {
  ...
  domesticwwTFac: DomesticWWTreatmentDischarge = new DomesticWWTreatmentDischarge()
  domesticwwTFacs:DomesticWWTreatmentDischarge [];
  constructor(
  ...
  ngOnInit(): void {
    ...
    if (this.id == -1) {
      this.domesticwwTFac = new DomesticWWTreatmentDischarge()
    }
    ...
    if (this.id > 0) {
      ...
      if (this.editEntryId && this.editEntryId > 0) {
        ...
        this.serviceProxy.getOneBaseDomesticWWTreatmentDischargeControllerDomesticWWTreatmentDischarge(
          this.editEntryId,
          undefined,
          undefined,
          0
        ).subscribe((res: any) => {
          this.domesticwwTFac = res;
        });
      }
...
loadEF(event :LazyLoadEvent){
  ...
  console.log(event);
    ...
    this.serviceProxy
      .getManyBaseDomesticWWTreatmentDischargeControllerDomesticWWTreatmentDischarge(
        undefined,
        undefined,
        undefined,
        undefined,
...
async saveWasteFac(wasteFacForm:NgForm){
  ...
  if (wasteFacForm.valid) {
    ...
    if (this.isNewEntry) {
      ...
      this.serviceProxy
        .createOneBaseDomesticWWTreatmentDischargeControllerDomesticWWTreatmentDischarge(this.domesticwwTFac)
        .subscribe((res: any) => {
      ...
      console.log("hhhhh")
      this.serviceProxy.updateOneBaseDomesticWWTreatmentDischargeControllerDomesticWWTreatmentDischarge(this.domesticwwTFac.id, this.domesticwwTFac)
        .subscribe(
          (res) => {
            this.messageService.add({
              severity: 'success',
