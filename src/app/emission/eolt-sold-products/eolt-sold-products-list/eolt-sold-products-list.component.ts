...
@Component({
  selector: 'app-eolt-sold-products-list',
  templateUrl: './eolt-sold-products-list.component.html',
  styleUrls: ['./eolt-sold-products-list.component.css']
})
export class EoltSoldProductsListComponent extends EmissionListBaseComponent implements OnInit {
  ...
  esCode: PuesDataReqDtoSourceName = PuesDataReqDtoSourceName.End_of_life_treatment_of_sold_products
  ...
  constructor(
    ...
    public eoltSoldProductsService:EndOfLifeTreatmentOfSoldProductsActivityDataControllerServiceProxy,
  ...
  edit(id: number) {
    this.router.navigate(['../eolt-sold-products-edit', id], {queryParams: { id: id }, relativeTo:this.activatedRoute });
  }

  view(id: number) {
    this.router.navigate(['../eolt-sold-products-view', id], { queryParams: { id: id } , relativeTo:this.activatedRoute });
  }

  new() {
    this.router.navigate(['../eolt-sold-products-add'], {relativeTo:this.activatedRoute});
  }
  ...
  delete(id: string) {
    this.eoltSoldProductsService.deleteAllEntry(id)
    .subscribe(res => {
  ...
  uploadExcell() {
    super.uploadExcell(PuesDataReqDtoSourceName.End_of_life_treatment_of_sold_products,this);
  }
  
  downloadExcel(){
    super.downloadExcel(PuesDataReqDtoSourceName.End_of_life_treatment_of_sold_products, this);
  }

  watchVideo(){
    super.watchVideo(PuesDataReqDtoSourceName.End_of_life_treatment_of_sold_products);
  }
