...
import {
  ...
  WasteGeneratedInOperationsActivityDataActivityDataStatus,
...
@Component({
  selector: 'app-waste-generated-in-operations-list',
  templateUrl: './waste-generated-in-operations-list.component.html',
  styleUrls: ['./waste-generated-in-operations-list.component.css']
})
export class WasteGeneratedInOperationsListComponent extends EmissionListBaseComponent implements OnInit {
  ...
  constructor(
    ...
    public wasteGeneratedInOperationsActivityDataControllerServiceProxy: WasteGeneratedInOperationsActivityDataControllerServiceProxy,
  ...
  load(event: LazyLoadEvent) {
    ...
    if(this.listLoadable()){
      this.wasteGeneratedInOperationsActivityDataControllerServiceProxy
        .getAllWasteGeneratedInOperationsData(pageNumber,this.rows,
  ...
  edit(groupNumber: number) {
    ...
    this.router.navigate(['../waste-generated-in-operations-edit'], {queryParams: { id: groupNumber }, relativeTo:this.activatedRoute });
  }

  view(groupNumber: number) {
    this.router.navigate(['../waste-generated-in-operations-view'], { queryParams: { id: groupNumber } , relativeTo:this.activatedRoute });
  }

  new() {
    this.router.navigate(['../waste-generated-in-operations-add'], {relativeTo:this.activatedRoute});
  }
