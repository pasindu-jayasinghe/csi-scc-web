...
export class InvestmentsListComponent extends EmissionListBaseComponent implements OnInit {
  ...
  esCode: PuesDataReqDtoSourceName = PuesDataReqDtoSourceName.Investments
  ...
  constructor(
    ...
    public investService:InvestmentsActivityDataControllerServiceProxy,
  ...
  load(event: LazyLoadEvent) {
    ...
    if(this.listLoadable()){
      this.investService
      .getAllInvestmentData(pageNumber,this.rows,
  ...
  edit(id: number) {
    this.router.navigate(['../investments-edit', id], {queryParams: { id: id }, relativeTo:this.activatedRoute });
  }

  view(id: number) {
    this.router.navigate(['../investments-view', id], { queryParams: { id: id } , relativeTo:this.activatedRoute });
  }

  new() {
    this.router.navigate(['../investments-add'], {relativeTo:this.activatedRoute});
  }
  ...
  uploadExcell() {
    super.uploadExcell(PuesDataReqDtoSourceName.Investments,this);
  }
  
  downloadExcel(){
    super.downloadExcel(PuesDataReqDtoSourceName.Investments, this);
  }

  watchVideo(){
    super.watchVideo(PuesDataReqDtoSourceName.Investments);
  }
