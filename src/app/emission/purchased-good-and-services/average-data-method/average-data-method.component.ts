...
@Component({
  selector: 'app-average-data-method',
  templateUrl: './average-data-method.component.html',
  styleUrls: ['./average-data-method.component.css']
})
export class AverageDataMethodComponent implements OnInit {
